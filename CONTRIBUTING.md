...
4. Skim [DESIGN.md](DESIGN.md) (architecture & usage) and [docs/dev/chunk-map.md](docs/dev/chunk-map.md) for package ownership.
...
3. **Doc-with-code.** User-facing changes update mapped docs/examples/fixtures.
